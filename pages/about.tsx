        ...
        <div className="w-full sm:max-w-xl mx-auto pt-4 px-4">
          <div className="mt-4 md:flex md:items-center md:justify-between bg-white my-2 rounded">
            <div className="flex-1 min-w-0 space-y-2 p-2">
              ...
              <div className="flex flex-cols-2">
                <h1 className="text-2xl font-bold leading-7 text-white bg-blue-900 rounded p-2 sm:text-4xl sm:truncate">
                  BantuCari
                </h1>
              </div>
              <p className="flex items-center text-sm leading-5 text-gray-700 sm:text-base">
                Sistem ini Dibuat untuk memudahkan masyarakat dalam mencari
                informasi oksigen, dengan memberikan informasi ketersediaan
                oksigen yang dikelola langsung oleh mitra penjual, sistem ini
                dibangun dari kolaborasi banyak individu, komunitas dan
                institusi yang tergerak untukk berkontribusi dalam peanganan
                pandemi di indonesia. BantuCari bersifat inklusif, independent
                dan non-partisan
              </p>
              <p className="flex items-center text-sm leading-5 text-gray-700 sm:text-base">
              ...
              <a href="mailto:bantucari@gmail.com">bantucari@gmail.com</a>
              <div className="flex flex-wrap justify-center items-center relative bg-gray-200 p-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-8 w-8 mx-1 hover:text-blue-900"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
                ...
                <svg
                  ...
                  data-prefix="fab"
                  data-icon="github"
                  className="w-8 h-8 mx-1 hover:text-blue-900"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 496 512"
                >
          ...
          <div className="px-4 overflow-hidden bg-white py-6 space-y-4 rounded">
            ...
            <div className="flex flex-wrap justify-center items-center relative">
              <a href="https://el.itera.ac.id" target="_blank" className="px-2">
                <div className="display: block; overflow: hidden; position: absolute; inset: 0px; box-sizing: border-box; margin: 0px;">
                  <img
                    src="https://el.itera.ac.id/wp-content/uploads/2021/04/cropped-logo-itera-elektro-transparan-power-point-rev-C-768x392.png"
                    alt="logo"
                    width={100}
                    height={100}
                  />
